...
class SynchrenityI18n {
    ...
    public function setFallbackLocale($locale) { $this->fallbackLocale = $locale; }
    public function getFallbackLocale() { return $this->fallbackLocale; }
    ...
    protected function selectPlural($forms, $count, $locale) {
        if (isset($forms[$count])) return $forms[$count];
        if (isset($forms['one']) && $count == 1) return $forms['one'];
        if (isset($forms['other'])) return $forms['other'];
        if (isset($forms[0]) && $count == 1) return $forms[0];
        if (isset($forms[1]) && $count != 1) return $forms[1];
